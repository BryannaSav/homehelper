...
urlpatterns = [
   ...
   path('listitem/edit/<int:item_id>/<int:list_id>', 
         views.edit_task, name='delete_task'),
   path('listitem/delete/<int:item_id>/<int:list_id>', 
         views.delete_task, name='delete_task'),
   path('calendar', views.calendar, name='calendar'),
   path('calendarevent/new', views.create_event, name='create_event'),
   path('api/calendar', views.api_calendar, name='calendar_data'),
   path('api/day/<str:date>', views.api_one_day, name='one_day'),
   path('api/task/complete/<int:id>', 
         views.api_complete_task, name='complete_task'),
]